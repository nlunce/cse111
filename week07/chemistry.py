...
def main():
    ...
    known_molecules_dict = known_molecules()
    ...
    moles = float(mass_in_grams)/molar_mass

    print(f'\nFormula Name: {formula_name.capitalize()}\n\nMolar Mass: {molar_mass:.5f}\n\nMoles: {moles:.5f}')
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:
        ...
        molar_mass = molar_mass + (atomic_mass * quantity)
